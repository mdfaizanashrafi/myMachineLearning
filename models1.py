...
cluster_df = pd.DataFrame(np.hstack((z, clusters.reshape(-1,1))), columns= df.columns)
...
transformed_x = pca.fit_transform(z)
...
truth_pcs_df = pd.DataFrame(np.hstack((transformed_x, df["class"].values.reshape(-1,1))),columns=["pca1","pca2","class"])

sns.scatterplot(x="pca1",y="pca2",hue="class",data=kmeans_pca_df)

#Truth CLasses 

sns.scatterplot(x="pca1",y="pca2",hue="class",data=truth_pcs_df)
plt.show()
